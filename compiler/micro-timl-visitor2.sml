...
type ('this, 'env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2_vtable =
     {
       ...
       visit2_TArray : 'this -> 'env -> int * ('var, 'bsort, 'idx, 'sort) ty * 'idx -> ('var2, 'bsort2, 'idx2, 'sort2) ty -> ('var3, 'bsort3, 'idx3, 'sort3) ty,
...
fun default_ty_visitor2_vtable
  ...
  let
    ...
    fun visit2_ty this env data other =
      ...
      in
        case data of
          ...
          | TArray data => #visit2_TArray vtable this env data other
          ...
          | TPreArray (w, t, i1, i2, b) =>
            (case other of
                 TPreArray (w', t', i1', i2', b') =>
                 TPreArray (visit2_eq op= this env w w', #visit2_ty vtable this env t t', #visit2_idx vtable this env i1 i1', #visit2_idx vtable this env i2 i2', visit_eq "visit_TPreArray/b=b'" b b')
               | _ => error (TPreArray (w, t, i1, i2, b)) other)
          | TArrayPtr (w, t, i1, i2) =>
            (case other of
                 TArrayPtr (w', t', i1', i2') =>
                 TArrayPtr (visit2_eq op= this env w w', #visit2_ty vtable this env t t', #visit2_idx vtable this env i1 i1', #visit2_idx vtable this env i2 i2')
               | _ => error (TArrayPtr (w, t, i1, i2)) other)
          | TPreTuple (ts, i, i2) =>
            (case other of
                 TPreTuple (ts', i', i2') =>
    ...
    fun visit2_TArray this env data other = 
      let
        val vtable = cast this
        val (w, t, i) = data
      in
        case other of
            TArray (w', t', i') =>
            let
              val w = visit2_eq op= this env w w'
              val t = #visit2_ty vtable this env t t'
              val i = #visit2_idx vtable this env i i'
            in
              TArray (w, t, i)
            end
          | _ => error (TArray data) other
      end
...
datatype ('env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2 =
         TyVisitor2 of (('env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2, 'env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2_interface
...
fun override_visit2_TVar (record : ('this, 'env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2_vtable) new : ('this, 'env, 'var, 'bsort, 'idx, 'sort, 'var2, 'bsort2, 'idx2, 'sort2, 'var3, 'bsort3, 'idx3, 'sort3) ty_visitor2_vtable =
  {
       ...
       visit2_TArray = #visit2_TArray record,
...
fun eq_t_fn params b b' =
  let
    val visitor2 as (TyVisitor2 vtable) = new_eq_t_visitor2 params
  in
...
fun test1 dirname =
  let
    ...
    val t1 = TTuple [TV 0, TV 1]
    val t2 = TTuple [TV 0, TV 2]
