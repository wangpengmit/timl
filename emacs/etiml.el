...
(defun etiml--setup-font-lock ()
  ...
  (let ((etiml-builtins '("BigO" "ceil" "floor" "b2n" "forall" "never" "log2" "log10"))
        (etiml-keywords '("return" "using" "absidx" "returns" "public" "private" "external" "internal" "guarded_by" "forward_to" "inherit_from" "contract" "endcontract" "interface" "endinterface" "endif" "for" "endfor" "while" "endwhile" "constant" "pure" "event" "init" "default" "map" "array" "vector" "address" "uint" "bytes32" "bool" "true" "false" "sha3" "super" "ref" "zerofy" "set" "modify" "days")))
